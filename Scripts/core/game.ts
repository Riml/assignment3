...
var game = (() => {
    ...
    function init() {
       ...
       // groundMaterial.bumpScale=1.2;
        ...
        var basicFinalCatEarsMaterial:LambertMaterial =new LambertMaterial({ color: 0xFFffFF, map: new THREE.TextureLoader().load( "./Assets/Textures/Ears.png" )});
        ...
        var material = currentCatMaterial;
        var ear1:Mesh= new THREE.Mesh( geometry, basicFinalCatEarsMaterial );
        var ear2:Mesh= new THREE.Mesh( geometry, basicFinalCatEarsMaterial );
